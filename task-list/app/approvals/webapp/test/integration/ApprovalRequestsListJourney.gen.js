...
sap.ui.define([
    ...
    function journey() {
        QUnit.module("ApprovalRequestsListListReport journey");
        ...
        opaTest("Start application", function (Given, When, Then) {
            ...
            Then.onTheApprovalRequestsListGenerated.iSeeThisPage();
        });
        ...
        //     When.onTheApprovalRequestsListGenerated.onFilterBar().iChangeSearchField("Search Term");
        //     When.onTheApprovalRequestsListGenerated.onFilterBar().iExecuteSearch();
        //     Then.onTheApprovalRequestsListGenerated.onTable(defaultTableId).iCheckRows();
        // });
        ...
        opaTest("Navigate to ObjectPage", function (Given, When, Then) {
            ...
            When.onTheApprovalRequestsListGenerated.onFilterBar().iExecuteSearch();
            Then.onTheApprovalRequestsListGenerated.onTable(defaultTableId).iCheckRows();
            When.onTheApprovalRequestsListGenerated.onTable(defaultTableId).iPressRow(0);
