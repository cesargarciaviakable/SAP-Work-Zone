...
sap.ui.define([
    ...
    function journey() {
        QUnit.module("InspeccionesListListReport journey");
        ...
        opaTest("Start application", function (Given, When, Then) {
            ...
            Then.onTheInspeccionesListGenerated.iSeeThisPage();
        });
        ...
        //     When.onTheInspeccionesListGenerated.onFilterBar().iChangeSearchField("Search Term");
        //     When.onTheInspeccionesListGenerated.onFilterBar().iExecuteSearch();
        //     Then.onTheInspeccionesListGenerated.onTable(defaultTableId).iCheckRows();
        //     When.onTheInspeccionesListGenerated.onFilterBar().iChangeSearchField(undefined);
        //     Then.onTheInspeccionesListGenerated.onFilterBar().iCheckSearchField(undefined);
        // });
        ...
        opaTest("Navigate to ObjectPage", function (Given, When, Then) {
            ...
            When.onTheInspeccionesListGenerated.onFilterBar().iExecuteSearch();
            Then.onTheInspeccionesListGenerated.onTable(defaultTableId).iCheckRows();
            When.onTheInspeccionesListGenerated.onTable(defaultTableId).iPressRow(0);
