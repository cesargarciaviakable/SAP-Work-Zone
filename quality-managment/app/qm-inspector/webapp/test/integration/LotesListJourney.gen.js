...
sap.ui.define([
    ...
    function journey() {
        QUnit.module("LotesListListReport journey");
        ...
        opaTest("Start application", function (Given, When, Then) {
            ...
            Then.onTheLotesListGenerated.iSeeThisPage();
        });
        ...
        //     When.onTheLotesListGenerated.onFilterBar().iChangeSearchField("Search Term");
        //     When.onTheLotesListGenerated.onFilterBar().iExecuteSearch();
        //     Then.onTheLotesListGenerated.onTable(defaultTableId).iCheckRows();
        //     When.onTheLotesListGenerated.onFilterBar().iChangeSearchField(undefined);
        //     Then.onTheLotesListGenerated.onFilterBar().iCheckSearchField(undefined);
        // });
        ...
        opaTest("Navigate to ObjectPage", function (Given, When, Then) {
            ...
            When.onTheLotesListGenerated.onFilterBar().iExecuteSearch();
            Then.onTheLotesListGenerated.onTable(defaultTableId).iCheckRows();
            When.onTheLotesListGenerated.onTable(defaultTableId).iPressRow(0);
